...
public class CmdMoneyTransferFp extends FCommand
{
	public CmdMoneyTransferFp()
	{
		...
		this.setHelpShort(Language.getInstance().helpMoneyTransferFpShort);
	...
	public void perform()
	{
		...
		if (success && Conf.logMoneyTransactions)
			P.p.log(ChatColor.stripColor(P.p.txt.parse(Language.getInstance().moneyTransferredFp, fme.getName(), Econ.moneyString(amount), from.describeTo(null), to.describeTo(null))));
	}
}
